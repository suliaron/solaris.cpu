...
namespace Constants
{
	...
	const std::string Usage				  = "Usage is -id <directory> -is <settings file> -ib <bodygrouplist file> -in <nebula file> | -c <directory> <settings file> <bodygrouplist file> <nebula file>\n";
